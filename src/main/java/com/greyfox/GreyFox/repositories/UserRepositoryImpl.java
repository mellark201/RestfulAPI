...
public class UserRepositoryImpl implements UserRepository{
    ...
    private static final String SQL_COUNT_BY_ID = "SELECT USER_ID, FIRST_NAME, LAST_NAME, PASSWORD FROM ET_USERS " +
            "WHERE USER_ID = ?";
    private static final String SQL_FIND_BY_EMAIL = "SELECT USER_ID, FIRST_NAME, LAST_NAME, PASSWORD FROM ET_USERS " +
            "WHERE EMAIL = ?";
    ...
    public User findByEmailAndPassword(String email, String password) throws ETAuthException {
        try {
            ...
            throw new ETAuthException("Invalid Login Details");
        }
    }
